...
class Register extends React.Component<any, any> {
    ...
    submit = async (e: SyntheticEvent) => {
        ...
        // const response: Response = await axios.post('http://localhost:8000/api/register', data);
        // if (response.error){
        ...
        await axios.post('register', data).then(response => {
            ...
            console.log('this.validationErrors', error);
        });
    ...
    render() {
        ...
        } else if(this.state && this.state.validationError){
            return (
                <ul>
                    ...
                    <form onSubmit={this.submit}>
                        ...
                        <div className="form-floating">
                            <input type="text" className="form-control"
                                   placeholder="First Name" onChange={event => this.first_name = event.target.value}/>
                            <label htmlFor="floatingInput">First Name</label>
                        </div>

                        <div className="form-floating">
                            <input type="text" className="form-control"
                                   placeholder="Last Name" onChange={event => this.last_name = event.target.value}/>
                            <label htmlFor="floatingInput">Last Name</label>
                        </div>

                        <div className="form-floating">
                            <input type="email" className="form-control"
                                   placeholder="name@example.com" onChange={event => this.email = event.target.value}/>
                            <label htmlFor="floatingInput">Email address</label>
                        </div>
                        <div className="form-floating">
                            <input type="password" className="form-control"
                                   placeholder="Password" onChange={event => this.password = event.target.value}/>
